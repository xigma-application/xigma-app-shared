...
import BorderRadiusT from "./svg/border-radius-t.svg?react";
import CarrotDown from "./svg/carrot-down.svg?react";
import Check from "./svg/check.svg?react";
import Checkbox from "./svg/checkbox.svg?react";
import CheckboxMixed from "./svg/checkbox-mixed.svg?react";
...
import FillVertical from "./svg/fill-vertical.svg?react";
...
import PaddingLR from "./svg/padding-lr.svg?react";
