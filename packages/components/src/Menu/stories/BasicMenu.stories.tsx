  ...
  props: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          props: [
            {
              attributes: [{ name: 'label', value: 'Redo' }, { name: 'shortcut', value: '⇧⌘Z' }, { name: 'disabled' }],
            },
          ],
        },
        { componentName: 'MenuSeparator', props: [{}] },
        {
          ...
          props: [
            {
              attributes: [{ name: 'icon', value: 'Lock' }, { name: 'label', value: 'Lock' }, { name: 'selected' }],
            },
          ],
        },
        {
          ...
          props: [
            {
              ...
              children: [
                {
                  componentName: 'MenuItem',
                  props: [{ attributes: [{ name: 'label', value: 'Rotate 90°' }] }],
                },
                {
                  componentName: 'MenuItem',
                  props: [
...
export const BasicMenu: Story = {
  play: playBasicMenu,
  render: (args) => (
    <StoryComponent blocksCodeData={[]} description={description} title="Basic Menu">
      <Menu {...args} />
    </StoryComponent>
  ),
};
...
export const RichMenu: Story = {
  ...
  play: playRichMenu,
  render: (args) => (
    <StoryComponent blocksCodeData={[blockCodeData]} description={description} title="Basic Menu">
      <Menu {...args} />
    </StoryComponent>
  ),
};
